...
var errors = 0;                     //Number of errors made by user, tallied for calculateError() method
...
const sentences = [
    ...
    "I don't know a good fifth sentence, WIP"
];
...
function calculateError(input, target)
{
    ...
    {
        if((target.charAt(i)).toUpperCase() === (input.charAt(i)).toUpperCase())
        {
            matches++;
        }
    }
...
function calculateAcc(input, expected)
{
    ...
    var charsWithErrors = input.length + errors;
...
function createSummary()
{
    ...
    var t2Str = "Test 1: " + testStats[1][0] + "/" + testStats[1][1] + " correct, WPM = " + (testStats[1][2]).toFixed(2) + ", Accuracy = " + (testStats[1][3]).toFixed(2); 
    var t3Str = "Test 1: " + testStats[2][0] + "/" + testStats[2][1] + " correct, WPM = " + (testStats[2][2]).toFixed(2) + ", Accuracy = " + (testStats[2][3]).toFixed(2); 
    var t4Str = "Test 1: " + testStats[3][0] + "/" + testStats[3][1] + " correct, WPM = " + (testStats[3][2]).toFixed(2) + ", Accuracy = " + (testStats[3][3]).toFixed(2);
    var t5Str = "Test 1: " + testStats[4][0] + "/" + testStats[4][1] + " correct, WPM = " + (testStats[4][2]).toFixed(2) + ", Accuracy = " + (testStats[4][3]).toFixed(2);
